...
public class Pool extends ResponseWithStatus {
  ...
  public String toString() {
    return MoreObjects.toStringHelper(Pool.class).add("status", status).add("URL", url)
        .add("poolStatus", poolStatus).add("priority", priority).add("Long Poll", longPoll)
        ...
        .add("Remote Failures", remoteFailures).add("User", user)
