...
public class Version extends ResponseWithStatus {
  ...
  public String toString() {
    return MoreObjects.toStringHelper(Version.class).add("status", status).add("cgminer", cgminer)
        .add("api", api).add("miner", miner).add("compileTime", compileTime).add("type", type)
        .toString();
  }
