...
public class ResponseParserTest {
	...
	public void parseResponse_errorStatusReturned() {
		final String input = "{\"STATUS\":[{\"STATUS\":\"E\",\"When\":1564141453,\"Code\":22,\"Msg\":\"custom message\",\"Description\":\"cgminer 4.9.0\"}],\"VERSION\":[{\"CGMiner\":\"4.9.0\",\"API\":\"3.1\",\"Miner\":\"1.0.1.3\",\"CompileTime\":\"Thu Apr 12 15:55:21 CST 2018\",\"Type\":\"Antminer L3++\"}],\"id\":1}";
	...
	public void parseResponse_successStatusReturned() {
		final String input = "{\"STATUS\":[{\"STATUS\":\"S\",\"When\":1564141453,\"Code\":22,\"Msg\":\"custom message\",\"Description\":\"cgminer 4.9.0\"}],\"VERSION\":[{\"CGMiner\":\"4.9.0\",\"API\":\"3.1\",\"Miner\":\"1.0.1.3\",\"CompileTime\":\"Thu Apr 12 15:55:21 CST 2018\",\"Type\":\"Antminer L3++\"}],\"id\":1}";
		Version v = responseParser.parseResponse(input, "VERSION", Version.class);
