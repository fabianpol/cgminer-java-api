...
public class JSONSyntaxCorrectorTest {
	...
	private static final String correctJson = "{\"commands\":[{\"command\":\"summary\"},{\"command\":\"version\"}]}";
	private static final String incorrectJson = "{\"commands\":[{\"command\":\"summary\"}{\"command\":\"version\"}]}";
